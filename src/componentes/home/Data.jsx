...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Luis Guerrero
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat sint ipsum ea ipsam voluptate fugit amet unde ipsa voluptas ab?</p>
            <a href="#contact" id='button-home' className="button button--flex">
                Say Hello
                <svg
